...
2. Install Command Line Tools:
	a. Open the application called `Terminal`. This can most easily be done by doing a spotlight search for the name.
	b. At the prompt, type `xcode-select --install` and hit enter.